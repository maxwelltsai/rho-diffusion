...
Copyright (c) 2021 OpenAI (MIT Licence)
...
from rho_diffusion.layers import avg_pool_nd
from rho_diffusion.layers import checkpoint
from rho_diffusion.layers import conv_nd
...
class AttentionPool2d(nn.Module):
    ...
    def __init__(
        ...
        self.c_proj = conv_nd(1, embed_dim, output_dim or embed_dim, 2)
...
@registry.register_model("UNetv2")
